"""
Django settings for data_viz_with_django project.
...
ROOT_URLCONF = 'data_viz_with_django.urls'
...
WSGI_APPLICATION = 'data_viz_with_django.wsgi.application'


# Database
# https://docs.djangoproject.com/en/2.0/ref/settings/#databases

db_name = os.path.join(BASE_DIR, 'data/wafergen_data.db')
